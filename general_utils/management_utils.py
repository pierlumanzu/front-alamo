...
def write_in_execution_time_file(date: str, algorithm_name: str, problem: Problem, n: int, elapsed_time: float):
...
def write_results_in_csv_file(p_list: np.array, f_list: np.array, date: str, algorithm_name: str, problem: Problem, export_pareto_solutions: bool=False):
...
def save_plots(p_list: np.array, f_list: np.array, date: str, algorithm_name: str, problem: Problem, export_pareto_solutions: bool, plot_dpi: int):
    assert len(p_list) == len(f_list)
