...
print('Initial solution(s): ', 'n feasible points randomly sampled' if general_settings['multiple_points_mod'] else '1 chosen feasible point')
print()
    ...
    for n in var_range:
        ...
        for algorithm_name in algorithms_names:
            ...
            with session.as_default():
                ...
                initial_p_list, initial_f_list, n_initial_points = points_initialization(problem_instance, 'rand', n if general_settings['multiple_points_mod'] else 1)
